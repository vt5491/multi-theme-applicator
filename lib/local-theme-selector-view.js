...
module.exports = LocalThemeSelectorView = (function() {
  ...
  LocalThemeSelectorView.prototype.selectNextTheme = function() {
    ...
    this.themeLookupActiveIndex %= LocalThemeSelectorView.prototype.ThemeLookup.length;
    return $("#themeDropdown").val(LocalThemeSelectorView.prototype.ThemeLookup[this.themeLookupActiveIndex].baseDir);
  };
  ...
  LocalThemeSelectorView.prototype.selectPrevTheme = function() {
    ...
    if (this.themeLookupActiveIndex < 0) {
      this.themeLookupActiveIndex = LocalThemeSelectorView.prototype.ThemeLookup.length - 1;
    }
    console.log("LocalThemeSelectorView.selectPrevTheme: themeLookupActiveIndex=" + this.themeLookupActiveIndex);
    console.log("LocalThemeSelectorView.selectPrevTheme: length=" + LocalThemeSelectorView.prototype.ThemeLookup.length);
    return $("#themeDropdown").val(LocalThemeSelectorView.prototype.ThemeLookup[this.themeLookupActiveIndex].baseDir);
  };
