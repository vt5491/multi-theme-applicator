...
Please open a file and then apply a local theme.`;
      ...
      getActiveThemeInfo(fn) {
         console.log("getActiveTheme: fileLookup=" + this.fileLookup);
         console.log(this.fileLookup);
         console.log("getActiveTheme: filleLookup[fn]=" + this.fileLookup[fn]);
         console.log("getActiveTheme: Base.FileTypeLookup=");
         console.log(Base.FileTypeLookup);
         // return 7;
         // return this.fileLookup[fn];
